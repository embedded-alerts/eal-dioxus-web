...
COPY --from=build /work/target/release/eal-dioxus-web /usr/local/bin/eal-dioxus-web
USER app
...
ENTRYPOINT ["/usr/local/bin/sops-entrypoint.sh", "/usr/local/bin/eal-dioxus-web"]
